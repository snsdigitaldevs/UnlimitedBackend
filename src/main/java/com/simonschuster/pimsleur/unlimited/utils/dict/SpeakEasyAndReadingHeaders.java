...
public class SpeakEasyAndReadingHeaders {
    ...
    public static final String HEADER_COURSE = "Course";

    /**
     * replace for Unit Num after 2019/5/21
     */
    ...
    public static final String HEADER_TRANSLITERATION = "Transliteration";
    public static final String HEADER_XLITHELP = "xlitHelp";
