...
public class PCMProgressConverterTest {
    ...
    public void shouldGroupByIdAndConvertToOneDTO() {
        List<UserAppStateDatum> edtProgresses = asList(
                new UserAppStateDatum("com.edt.models::Customer_124302#currentMediaSetHistoryId", "1243029781442319875", ""),
                new UserAppStateDatum("com.edt.models::MediaSetHistory_1243029781442319875#currentMediaItemHistoryId", "124302978144231987541916", ""),
    ...
    public void shouldFindCurrentItem() {
        List<UserAppStateDatum> edtProgresses = asList(
                new UserAppStateDatum("com.edt.models::MediaItemHistory_124302978144231493141916#audioTrackComplete", true, ""),
