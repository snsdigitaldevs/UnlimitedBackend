...
public class UrlUtilTest {
    ...
    public void shouldEncodeUrlCorrectly() throws Exception {
        ...
        assertEquals("https://install.pimsleurunlimited.com/staging_n/common/mandarinchinese/Mandarin+Chinese+I/audio/9781442394872_Mandarin_Chinese1_U01_Lesson.mp3", encodedUrl);
    }
}